...
def app():
    ...
    with st.container():
        ...
        with st.expander('详解请点击此处'):
            st.write('首先上传一张图片，用户可以自己选择加密框的大小与位置，，然后根据自己的需要，再通过图像加密的方式，只对用户感兴趣的部分进行加密')
    ...
    with st.container():
        ...
        with text_column:
            ...
            st.write('')
        with st.expander('详解请点击此处'):
            st.write('首先上传一张图片，系统会开始对图片或者视频进行分割，然后根据可以自己的需要，选择好分割的部分，再通过图像加密的方式，只对用户感兴趣的部分进行加密')
    ...
    with st.container():
        ...
        with text_column:
            ...
            st.write('')
        with st.expander('详解请点击此处'):
            st.write('用户可以上传自己需要解密的影像，然后系统将图片进行解密')
